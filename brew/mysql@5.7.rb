# Because MySQL 5.7 is no longer supported for installation via Homebrew, 
# you can manually install it through the Homebrew Formula with the following command:
# brew install ./mysql@5.7.rb
